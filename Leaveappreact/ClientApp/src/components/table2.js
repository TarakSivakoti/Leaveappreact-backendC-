                ...
                if (report && report.hasOwnProperty('leaveReport')) {
                  return (
                    <tr className="head-tab">
                      ...
                      {report.leaveReport.approvalstatus.toLowerCase() === "pending" ? <td className="pencil"></td> : <td className="pencil"></td>}
                      {report.leaveReport.approvalstatus.toLowerCase() === "pending" ? <td className="delete"></td> : <td className="delete"></td>}
                    </tr>
                  )
                };
                return "";
